...
UPDATE Customer
SET Phone_no = '9999993991'
WHERE State = 'CA' AND First_name = 'Jane' AND Last_name = 'Smith';

UPDATE Customer
SET Phone_no = '9999995692'
WHERE State = 'CA' AND First_name = 'Olivia' AND Last_name = 'Davis';
